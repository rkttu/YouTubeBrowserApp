...
using AccuRadioBrowserApp.Properties;
...
namespace AccuRadioBrowserApp
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            var uri = new Uri("https://www.accuradio.com/", UriKind.Absolute);
            var lastUri = default(Uri);

            if (!string.IsNullOrWhiteSpace(firstArgs))
                uri = new Uri($"https://www.accuradio.com/watch?v={Uri.EscapeDataString(firstArgs)}", UriKind.Absolute);
                ...
                lastUri.Host.EndsWith("accuradio.com", StringComparison.OrdinalIgnoreCase))
                uri = lastUri;
